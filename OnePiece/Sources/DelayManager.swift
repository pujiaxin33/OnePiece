...
class DelayManager {
    ...
    func registerTask(taskID: String, delay: TimeInterval, taskBlock: @escaping ()->()) {
    ...
    func unregisterTask(taskID: String) -> DelayTask? {
    ...
    func executeAllTasksImmediately() {
...
class DelayTask {
    ...
    init(taskID: String, delay: Double, taskBlock: @escaping (()->())) {
        self.taskID = taskID
        self.delay = delay
